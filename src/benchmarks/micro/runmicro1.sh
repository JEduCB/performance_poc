...
#sudo DOTNET_EnableAVX512F=1 LD_PRELOAD=/usr/lib/x86_64-linux-gnu/engines-1.1/libplock.so \
     sudo DOTNET_PROCESSOR_COUNT=$1 OPENSSL_ASYNC_ENABLED=$2 QAT_ENGINE=QAT_$3 \
     dotnet run -c Release -f net8.0 --statisticalTest $4 --filter System.Net.Security.Tests.SslStreamTests.$5 --apples --iterationCount $6 \
