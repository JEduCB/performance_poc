...
sudo LD_PRELOAD=/usr/lib/x86_64-linux-gnu/engines-1.1/libplock.so DOTNET_PROCESSOR_COUNT=$1 OPENSSL_ASYNC_ENABLED=$2 QAT_ENGINE=QAT_$3 \
     ...
     "/home/user/git/innersource/dotnet.runtime.poc/artifacts/bin/testhost/net8.0-linux-Release-x64/shared/Microsoft.NETCore.App/8.0.0/corerun" --hide Job Toolchain --apples --iterationCount $6
